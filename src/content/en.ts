...
export const en = {
  global: {
    ...
    footer: {
      ...
      firma: {
        heading: "Firm",
        links: ["About Us", "Technology", "Labor Inclusion", "Team"],
      },
      servicios: {
        heading: "Services",
        links: [
      ...
      hablemos: {
        heading: "Let's Talk",
        body: "Tell us your case. We respond in less than 24 hours.",
        cta: "Schedule consultation",
      },
      copyright: "Santos & Becker. All rights reserved.",
      ...
      newsletter: {
        ...
        cta: "Subscribe",
        disclaimer: "Confidential information. Data handling regulated.",
      },
      editorial: {
  ...
  home: {
    ...
    alliances: {
      eyebrow: "Strategic Collaborations",
      title: "Alliances and affiliations",
      subtitle:
    ...
    cta: {
      ...
      fields: {
        ...
        correo: { label: "Email", placeholder: "you@company.com" },
        mensaje: { label: "Message", placeholder: "How can we help you?" },
      },
      submitBtn: "Send request",
      successMessage:
        "Thank you. Your inquiry has been sent to the Santos & Becker team. We will be in touch within 24 hours.",
      ctaPrimary: "Contact Us",
      ...
      steps: [
        {
          ...
          desc: "Each case begins with a thorough analysis of the client's corporate or personal situation, identifying risks, opportunities, and the optimal immigration route.",
        },
        {
          step: "02",
          title: "Custom Design",
          desc: "We develop a fully personalized immigration strategy — no standard templates. Each solution is as unique as the client's needs.",
        },
        {
          step: "03",
  ...
  servicios: {
    ...
    personal: {
      ...
      intro:
        "We accompany individuals — both national and foreign — at every step of their immigration process in Mexico.",
      items: [
        {
          title: "Temporary residencies",
          desc: "Obtaining and renewing temporary residencies based on job offer, family ties, or other categories.",
        },
        {
          title: "Permanent residencies",
          desc: "Management of the process for obtaining permanent residency in Mexican territory.",
        },
        {
          title: "Mexican nationality",
          desc: "Comprehensive support throughout the naturalization process to obtain Mexican nationality.",
        },
        {
          title: "Other nationalities",
          desc: "Management of procedures for obtaining citizenship of other countries through their consular representations in Mexico.",
        },
        {
          title: "International visas",
          desc: "Obtaining tourist, business, or work visas for the United States and any other country.",
        },
        {
          title: "Employment documents",
          desc: "Obtaining RFC, Social Security number (IMSS), and other registrations required for entering the workforce in Mexico.",
        },
      ],
    },
    complementary: {
      ...
      title: "Complementary Services",
      intro:
        "Additional services that complement the immigration experience and facilitate each person's integration into the country.",
      items: [
        {
          title: "Apostilles, legalizations, and translations",
          desc: "Complete document management to validate documents in Mexico or abroad.",
        },
        {
          title: "Relocation",
          desc: "Coordination of relocation services, housing search, schools, and cultural orientation through specialized partners.",
        },
        {
          title: "International consulting",
          desc: "Advisory on international mobility matters for operations in Mexico or in any other country.",
        },
      ],
      cta: "Schedule consultation",
    },
  ...
  equipo: {
    ...
    oscar: {
      ...
      name: "Oscar Santos",
      bio: [
        "Founding partner of Santos & Becker and one of the most recognized figures in corporate immigration consulting in Mexico. With a vision focused on service quality and long-term relationship building, Oscar has led the transformation of immigration practice in the private sector.",
        "Previously, he was the leading partner of the immigration practice for Latin America at Ernst & Young (EY) for 13 years, where he drove sustained double-digit growth.",
        "He actively drives labor inclusion initiatives for migrant talent through strategic alliances with IOM and UNHCR.",
      ],
      email: "osantos@santosbecker.com",
      linkedin: "https://mx.linkedin.com/in/oscar-santos-77a028b2",
    },
    cesar: {
      eyebrow: "Founding Partner",
      name: "César Becker",
      bio: [
        "Founding partner of Santos & Becker and a leading figure in immigration law with more than 25 years of professional practice. His practice combines deep legal expertise with a unique ability to build trust relationships with immigration authorities and key private sector players.",
        "Committed to modern and inclusive legal practice, César has focused part of his work on supporting foreign entrepreneurs seeking to integrate and grow within Mexico's business environment.",
      ...
      email: "cbecker@santosbecker.com",
      linkedin: "https://mx.linkedin.com/in/cesar-becker-noriega-abogado-migratorio/en",
    },
    team: {
      eyebrow: "Team",
      title: "Our team",
  ...
  tecnologia: {
    ...
    plataforma: {
      ...
      features: [
        ...
        { n: "03", title: "Full Traceability", desc: "Complete record of every process action, automatic notifications upon status changes, and exportable executive reports." },
      ],
      capabilitiesEyebrow: "Capabilities",
      capabilitiesTitle: "Designed for demanding corporate operations",
      capabilities: [
        "Multi-company panel for corporate groups",
        "Automatic expiration and renewal alerts",
        "Integration with HR systems (SAP, Workday)",
        "Executive reports and compliance reports",
        "Secure access from any device",
        "Repository with role-based granular access control",
      ],
      workflowEyebrow: "Workflow",
      workflowTitle: "How it works",
      workflow: [
        { step: "01", title: "Digital Onboarding", desc: "Secure initial information upload through the encrypted portal. Case activated within 24 business hours." },
        { step: "02", title: "Processing", desc: "The legal team manages the case with real-time visibility for the client at every stage of the process." },
        { step: "03", title: "Resolution", desc: "Digital receipt of approvals and automatic storage in the corporate repository. Immediate notification." },
      ],
      cta: "Request a demo",
    },
    sam: {
  ...
  inclusion: {
      ...
      services: [
        {
          ...
          desc: "We offer free consulting to any company interested in hiring migrant talent in Mexico.",
        },
        {
          title: "Direct employment of refugees",
    ...
    methodology: {
      ...
      steps: [
        { n: "01", title: "Corporate Diagnosis", desc: "Analysis of organizational structure, hiring proportions, and current regulatory risks." },
        { n: "02", title: "Compliance Strategy", desc: "Design of a personalized action plan to ensure regulatory compliance in every hire." },
        { n: "03", title: "Document Implementation", desc: "Management of all contracts, registrations, and procedures before competent authorities." },
        { n: "04", title: "Continuous Monitoring", desc: "Periodic follow-up to update records and anticipate regulatory changes." },
      ],
      stats: [
  ...
  contacto: {
    ...
    form: {
      ...
      placeholders: {
        nombre: "Your name",
        empresa: "Your company name (optional)",
        email: "email@company.com",
        telefono: "+52 55 0000 0000",
        mensaje: "Briefly describe your situation or inquiry",
      },
      consultationTypes: [
        "Corporate services",
        "Personal services",
      ...
      submitBtn: "Send",
      privacyNote: "By submitting, you accept our privacy notice.",
      successMessage:
        "Thank you. Your inquiry has been sent to the Santos & Becker team. We will be in touch within 24 hours.",
    },
    contactInfo: {
      ...
      email: "info@santosbecker.com",
      phone: "+52 55 6617 7712",
      whatsapp: "+52 55 6617 7712",
      whatsappNumber: "525566177712",
      phoneLabel: "Phone",
      emailLabel: "Email",
      waLabel: "WhatsApp",
    ...
    alternativeCta: {
      ...
      subtitle:
        "Message us on WhatsApp and our team will attend to you immediately.",
      ctaPrimary: "Message on WhatsApp",
      ctaSecondary: "Meet SAM",
    },
  },
} as const;

...
export const es = {
  global: {
    ...
    footer: {
      ...
      firma: {
        heading: "Firma",
        links: ["Nosotros", "Tecnología", "Inclusión Laboral", "Equipo"],
      },
      servicios: {
        heading: "Servicios",
        links: [
      ...
      hablemos: {
        heading: "Hablemos",
        body: "Cuéntenos su caso. Respondemos en menos de 24 horas.",
        cta: "Agendar consulta",
      },
      copyright: "Santos & Becker. Todos los derechos reservados.",
      privacy: "Aviso de Privacidad",
      terms: "Términos y Condiciones",
      regulatory: "Aviso Regulatorio",
      officeLabel: "Oficina",
      newsletter: {
        label: "Actualizaciones estratégicas",
        placeholder: "Dirección de email",
        cta: "Suscribir",
        disclaimer: "Información confidencial. Manejo de datos regulado.",
      },
      editorial: {
        heading: "El Estándar\nProfesional.",
    ...
    whatsapp: {
      number: "525566177712",
      message:
        "Hola, me gustaría recibir información sobre los servicios de Santos & Becker.",
  ...
  home: {
    ...
    alliances: {
      eyebrow: "Colaboraciones Estratégicas",
      title: "Alianzas y afiliaciones",
      subtitle:
    ...
    bespoke: {
      ...
      cta: "Solicitar atención Bespoke",
    },
    ...
    cta: {
      ...
      fields: {
        ...
        empresa: { label: "Empresa", placeholder: "Tu empresa" },
        correo: { label: "Correo", placeholder: "tu@empresa.com" },
        mensaje: { label: "Mensaje", placeholder: "¿Cómo podemos ayudarte?" },
      },
      submitBtn: "Enviar solicitud",
      successMessage:
        "Gracias. Su consulta ha sido enviada al equipo de Santos & Becker. Nos pondremos en contacto en menos de 24 horas.",
      ctaPrimary: "Contáctanos",
      ...
      steps: [
        {
          ...
          desc: "Cada caso comienza con un análisis profundo de la situación corporativa o personal del cliente, identificando riesgos, oportunidades y la ruta migratoria óptima.",
        },
        {
          step: "02",
          title: "Diseño a Medida",
          desc: "Desarrollamos una estrategia migratoria totalmente personalizada, sin plantillas estándar. Cada solución es tan única como las necesidades del cliente.",
        },
        {
          step: "03",
  ...
  servicios: {
    ...
    personal: {
      ...
      intro:
        "Acompañamos a personas físicas, nacionales y extranjeras, en cada paso de su proceso migratorio en México.",
      items: [
        {
          title: "Residencias temporales",
          desc: "Obtención y renovación de residencias temporales por oferta de trabajo, vínculo familiar u otras categorías.",
        },
        {
        ...
        },
        {
          ...
          desc: "Acompañamiento integral en el proceso de naturalización para obtener la nacionalidad mexicana.",
        },
        {
        ...
        },
        {
          ...
          desc: "Obtención de visas de turismo, negocios o trabajo para Estados Unidos y cualquier otro país.",
        },
        {
          title: "Documentos laborales",
          desc: "Obtención de RFC, número de Seguridad Social (IMSS) y demás registros necesarios para la incorporación al trabajo en México.",
        },
      ],
    },
    complementary: {
      ...
      title: "Servicios Complementarios",
      intro:
        "Servicios adicionales que complementan la experiencia migratoria y facilitan la integración de cada persona en el país.",
      items: [
        {
        ...
        {
          title: "Relocation",
          desc: "Coordinación de servicios de reubicación, búsqueda de vivienda, escuelas y orientación cultural, a través de socios especializados.",
        },
        {
          title: "Consultoría internacional",
          desc: "Asesoría en temas de movilidad internacional para operaciones en México o en cualquier otro país.",
        },
      ],
      cta: "Agendar consulta",
    },
  ...
  tecnologia: {
    ...
    plataforma: {
      ...
      capabilitiesTitle: "Diseñada para la operación corporativa exigente",
      capabilities: [
  ...
  inclusion: {
    ...
    position: {
      ...
      services: [
        {
          title: "Consultoría pro bono",
          desc: "Ofrecemos consultoría sin costo a cualquier empresa interesada en contratar talento migrante en México.",
        },
        {
          title: "Empleo directo de refugiados",
  ...
  contacto: {
    ...
    form: {
      ...
      placeholders: {
        nombre: "Su nombre",
        empresa: "Nombre de su empresa (opcional)",
        email: "email@empresa.com",
        telefono: "+52 55 0000 0000",
        mensaje: "Describa brevemente su situación o consulta",
      },
      consultationTypes: [
      ...
      submitBtn: "Enviar",
      privacyNote: "Al enviar, acepta nuestro aviso de privacidad.",
      successMessage:
        "Gracias. Su consulta ha sido enviada al equipo de Santos & Becker. Nos pondremos en contacto en menos de 24 horas.",
    },
    contactInfo: {
    ...
    alternativeCta: {
      ...
      title: "¿Prefiere una conversación directa?",
      subtitle:
        "Escríbanos por WhatsApp y nuestro equipo le atenderá de inmediato.",
      ctaPrimary: "Escribir por WhatsApp",
      ctaSecondary: "Conocer SAM",
    },
  },
} as const;

export type EsContent = typeof es;
